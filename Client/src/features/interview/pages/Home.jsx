                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            <label className='section-label'>
                                Upload Resume
                                <span className='badge badge--best'>Mandatory</span>
                            </label>
                        ...
                        {/* AND Divider */}
                        <div className='and-divider'><span>AND</span></div>

                        {/* Quick Self-Description */}
                        <div className='self-description'>
                            <label className='section-label' htmlFor='selfDescription'>Quick Self-Description
                        ...
                        <div className='info-box'>
                            ...
                            <p><strong>Resume</strong> is mendotery and <strong>Self Description</strong> is optional to generate a personalized plan.</p>
                        </div>
                    </div>
                </div>
